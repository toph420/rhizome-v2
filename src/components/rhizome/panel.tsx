...
const SIDEBAR_HEIGHT_ICON = "3rem"  // 48px for collapsed horizontal panels
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed z-10 hidden transition-all duration-200 ease-linear md:flex",
          // Vertical panels (left/right)
          isVertical && [
            "inset-y-0 h-svh w-(--sidebar-width) transition-[left,right,width]",
            side === "left"
          ...
          isHorizontal && [
            "inset-x-0 w-full h-(--sidebar-height) transition-[bottom,top,height]",
            side === "bottom"
            ...
            variant === "floating" || variant === "inset"
              ? "p-2 group-data-[collapsible=icon]:h-[calc(var(--sidebar-height-icon)+(--spacing(4))+2px)]"
              : "group-data-[collapsible=icon]:h-(--sidebar-height-icon) group-data-[side=bottom]:border-t-2 border-t-border group-data-[side=top]:border-b-2 border-b-border",
          ],
          className,
        )}
        {...props}
...
export {
  ...
  SidebarGroup as PanelGroup,
  SidebarGroupAction as PanelGroupAction,
  SidebarGroupContent as PanelGroupContent,
  SidebarGroupLabel as PanelGroupLabel,
  SidebarHeader as PanelHeader,
  SidebarInput as PanelInput,
  SidebarInset as PanelInset,
  SidebarMenu as PanelMenu,
  SidebarMenuAction as PanelMenuAction,
  SidebarMenuBadge as PanelMenuBadge,
  SidebarMenuButton as PanelMenuButton,
  SidebarMenuItem as PanelMenuItem,
  SidebarMenuSkeleton as PanelMenuSkeleton,
  SidebarMenuSub as PanelMenuSub,
  SidebarMenuSubButton as PanelMenuSubButton,
  SidebarMenuSubItem as PanelMenuSubItem,
  SidebarProvider as PanelProvider,
  SidebarRail as PanelRail,
  SidebarTrigger as PanelTrigger,
  useSidebar as usePanelContext,
}
